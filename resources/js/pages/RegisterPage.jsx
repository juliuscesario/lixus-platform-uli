...
export default function RegisterPage({ onRegisterSuccess, setPage }) {
    // ... (Salin seluruh kode fungsi RegisterPage dari app.jsx lama ke sini) ...
        ...
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
                    Buat Akun Influencer Baru
                </h2>
                <p className="mt-2 text-center text-sm text-gray-600">
                    Sudah punya akun?{' '}
                    <a href="#" onClick={() => setPage('login')} className="font-medium text-pink-600 hover:text-pink-500">
                        Login di sini
                    </a>
                </p>
            </div>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input id="password_confirmation" name="password_confirmation" type="password" required value={passwordConfirmation} onChange={(e) => setPasswordConfirmation(e.target.value)}
                                    className="appearance-none block w-full px-3 py-2 pl-10 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm"
