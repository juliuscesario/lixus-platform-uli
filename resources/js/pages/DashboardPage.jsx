            ...
            <div className="mt-8 bg-white p-8 rounded-lg shadow-lg">
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-pink-100 p-6 rounded-lg">
                        ...
                        <button className="mt-3 text-sm font-semibold text-pink-800 hover:underline">Kelola Profil &rarr;</button>
                    </div>
                     <div className="bg-blue-100 p-6 rounded-lg">
                        ...
                        <button className="mt-3 text-sm font-semibold text-blue-800 hover:underline">Lihat Kampanye &rarr;</button>
                    </div>
                     <div className="bg-green-100 p-6 rounded-lg">
                        ...
                        <button className="mt-3 text-sm font-semibold text-green-800 hover:underline">Hubungkan Akun &rarr;</button>
                    </div>
                </div>
            </div>
        </div>
